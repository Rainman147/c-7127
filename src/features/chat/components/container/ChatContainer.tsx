...
const ChatContainer = ({
  ...
  return <div className="flex h-screen w-full">
      <div className="flex-1 flex flex-col">
        <ChatHeader currentChatId={currentChatId} onTemplateChange={onTemplateChange} onPatientSelect={onPatientSelect} selectedPatientId={selectedPatientId} />
        ...
        <div className="relative w-full bg-gradient-to-t from-chatgpt-main via-chatgpt-main to-transparent pb-3 pt-6 rounded-none px-[8px] py-[21px]">
          <div className="px-4 sm:px-6 md:px-8">
            <div className="mx-auto max-w-2xl">
              <ChatInput onSend={onMessageSend} onTranscriptionComplete={onTranscriptionComplete} onTranscriptionUpdate={handleTranscriptionUpdate} isLoading={isLoading} draftMessage={draftMessage} onDraftChange={onDraftChange} directMode={directMode} onDirectModeToggle={onDirectModeToggle} />
            </div>
          </div>
        </div>
      </div>
